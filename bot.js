...
app.get("/", (request, response) => {
  console.log(Date.now() + "Duble Krallar");
...
.setDescription(`<a:emoji_50:753975225686687774> <@!${message.author.id}> adlı kullanıcı tarafından <#${message.channel.id}> kanalına gönderilen mesaj silindi!\n\nSilinen Mesaj: **${message.content}**`)
...
if (!modlogkanal) return;
  ...
  .setColor("#ffd100")
    ...
    .setDescription(`<a:emoji_50:753975225686687774> Üye Sunucudan Yasaklandı! \n<@!${message.user.id}>, ${message.user.tag}`)
...
if (!modlogkanal) return;
    if (channel.type === "text") {
                let embed = new Discord.RichEmbed()
                    .setColor('#ffd100')
                .setDescription(`<a:emoji_50:753975225686687774> ${channel.name} adlı metin kanalı oluşturuldu.`)
...
.setTitle("SES KANALI OLUŞTURULDU")
                .setDescription(`<a:emoji_50:753975225686687774> ${channel.name} adlı ses kanalı oluşturuldu!`)
                .setFooter(`Duble Krallar | Log Sistemi Kanal ID: ${channel.id}`)
...
if (!modlogkanal) return;
    if (channel.type === "text") {
                let embed = new Discord.RichEmbed()
                    .setColor('#ffd100')
                .setDescription(`<a:emoji_50:753975225686687774> ${channel.name} adlı metin kanalı silini!`)
                .setFooter(`Duble Krallar | Log Sistemi Kanal ID: ${channel.id}`)
                modlogkanal.send({embed});
            };
            if (channel.type === "voice") {
...
.setTitle("SES KANALI SİLİNDİ")
                .setDescription>(`<a:emoji_50:753975225686687774> ${channel.name} adlı ses kanalı silindi`)
            .setFooter(`Duble Krallar | Log Sistemi  Kanal ID: ${channel.id}`)
                modlogkanal.send({embed});
            }
    })
...
message.delete()
message.reply('<a:emoji_50:753975225686687774> **Hey Dostum Bu Sunucuda Reklam Yasak**').then(msg => msg.delete(7000)) 
}
});
//Frenzy Code
client.on("messageUpdate", async (oldMsg, newMsg) => {
...
newMsg.delete()
oldMsg.reply('<a:emoji_50:753975225686687774> **Hey Dostum Bu Sunucuda Reklam Yasak**').then(msg => msg.delete(7000)) 
}
});
          ...
          if (reklam.some(word => message.content.toLowerCase().includes(word))) {
              if (!message.member.hasPermission("ADMINISTRATOR")) {
                  ...
                  if (uyarisayisi === null) {
                      ...
                      .setDescription(`<a:emoji_50:753975225686687774> **<@${message.author.id}> Reklam Kick Sistemine Yakalandın! Reklam Yapmaya Devam Edersen Kickleniceksin (1/3)**`)
                          .setTimestamp()
                  ...
                  if (uyarisayisi === 1) {
                      let uyari = new Discord.RichEmbed()
                          .setColor("#ffd100")
                          .setFooter('Duble Krallar', client.user.avatarURL)
                      .setDescription(`<a:emoji_50:753975225686687774> **<@${message.author.id}> Reklam Kick Sistemine Yakalandın! Reklam Yapmaya Devam Edersen Kickleniceksin (2/3)**`)
                          .setTimestamp()
                      message.channel.send(uyari)
                  }
                  if (uyarisayisi === 2) {
                      ...
                      let uyari = new Discord.RichEmbed()
                          .setColor("#ffd100")
                          .setFooter('Duble Krallar', client.user.avatarURL)
                          .setDescription(`<a:emoji_50:753975225686687774> **<@${message.author.id}> 3 Adet Reklam Uyarısı Aldığı İçin Kicklendi. Bir Kez Daha Yaparsa Banlanacak**`)
                          .setTimestamp()
                      message.channel.send(uyari)
                  }
                  if (uyarisayisi === 3) {
                      ...
                      let uyari = new Discord.RichEmbed()
                          .setColor("#ffd100")
                          .setFooter('Duble Krallar', client.user.avatarURL)
                          .setDescription(`<a:emoji_50:753975225686687774> **<@${message.author.id}> Kick Yedikten Sonra Tekrar Devam Ettiği İçin Banlandı.**`)
                          .setTimestamp()
                      message.channel.send(uyari)
                  }
...
if (!role) {
  member.addRole(member.guild.roles.get(otorol))
                        ...
                        .setDescription("<a:emoji_50:753975225686687774> **Sunucuya Yeni Katılan** @" + member.user.tag + " **Kullanıcısına** <@&" + otorol + ">  **Rolü verildi**")
                        .setColor('#ffd100') 
                        .setFooter(`Duble Krallar Otorol Sistemi`)
     member.guild.channels.get(i).send(embed) 
} else if (role) {
    member.addRole(member.guild.roles.get(otorol))
                        var embed = new Discord.RichEmbed()
                        .setDescription(`<a:emoji_50:753975225686687774> **Sunucuya Yeni Katılan** \`${member.user.tag}\` **Kullanıcısına** \`${role}\` **Rolü verildi**`)
                        .setColor('#ffd100') 
                        .setFooter(`Duble Krallar Otorol Sistemi`)
     member.guild.channels.get(i).send(embed) 
...
client.on('message', async (msg, member, guild) => {
  let i = await  db.fetch(`saas_${msg.guild.id}`)
      if(i === 'açık') {
        ...
        msg.reply('<a:kral2:740243285376761916> **Aleyküm Selam, Hoşgeldin** <a:yldz:752666455337861250>');      
      } 
      }
    });
///////////////////////
...
client.on("guildMemberAdd", async member => {
  ...
  if(miran){
    ...
    const amil = new Discord.RichEmbed()
      .setColor("#ffd100")
      .setDescription(`<a:emoji_50:753975225686687774> **@${member.user.tag}** Adlı Kişiye Tag Verildi!`)
      .setFooter(client.user.username, client.user.avatarURL);
...
client.on("message", msg => {
  var dm = client.channels.get("752992045920157837")
 ...
 console.log(`Oops! ${e}`);
         ...
         client.on("roleDelete", async(role , channel , message , guild) => {
          ...
          role.guild.createRole({name: role.name, color: role.color,  permissions: role.permissions}) 
                role.guild.owner.send(`<a:emoji_50:753975225686687774> **${role.name}** Adlı Rol Silindi Ve Ben Rolü Tekrar Oluşturdum  :white_check_mark:`)
        ...
        client.on("guildMemberAdd", async member => {
          ...
          member.guild.owner.send(`<a:emoji_50:753975225686687774> Sunucunuza Bir Bot Eklendi ve Sunucudan Otomatik Olarak Atıldı, Sunucuya Eklenmesini Onaylıyor iseniz \`-giriş-izni ${member.id}\``)
          })
...
client.on("message" , async message => {
 ...
 if(afk){
   ...
   if(message.content.includes(kisi3)){
     const embed = new Discord.RichEmbed()
      .setColor("#0080FF")
      .setAuthor("Duble Krallar" , client.user.avatarURL)
...
client.on('guildMemberAdd', async(member) => {
   ...
   let channel = client.channels.get("756576708336812072")//KANAL ID
